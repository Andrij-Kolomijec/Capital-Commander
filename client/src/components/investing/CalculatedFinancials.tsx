...
export default function CalculatedFinancials(props: FinancialsProps) {
  ...
  const estPriceDividend =
    Math.round((+PEMedian * rows[6].eps + totalDividend) * 100) / 100;
      ...
      <table className={classes["table-first"]}>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{estPriceDividend}</td>
          </tr>
          <tr>
            <td>Profit in 7 years</td>
            <td>{profitIn7Years}</td>
          </tr>
          <tr>
            <td>Profit in 7 years in %</td>
            <td>{Math.round(profitIn7YearsInPercent * 100)} %</td>
          </tr>
          <tr>
            <td>Yearly profit in %</td>
            <td>{Math.round(yearlyProfitInPercent * 10000) / 100} %</td>
          </tr>
        </tbody>
      </table>
