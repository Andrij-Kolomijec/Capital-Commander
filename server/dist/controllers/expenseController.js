...
function getAllExpenses(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const expenses = yield expenseModel_1.default.find({}).sort({ date: -1 });
...
function createExpense(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(0, validators_1.isValidText)(notes)) {
        ...
        try {
            const expense = yield expenseModel_1.default.create({ description, date, amount, notes });
